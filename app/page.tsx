    ...
    <>
      ...
      {playAnimation ? (
        <main className="overflow-x-hidden scrollbar-thin scrollbar-track-slate-300 scrollbar-thumb-gray-900 dark:bg-slate-900 dark:scrollbar-track-blue-900 ">
          ...
          <section
            id="Landing"
            className="black mx-auto flex min-h-[90vh] w-full flex-row items-center justify-around bg-[#191919]"
          >
            <div className="flex w-full flex-col items-center justify-center md:gap-4 lg:flex-row">
          ...
          >
            <div className="h-full w-full">
              ...
              <div className="flex h-[80%] w-full flex-col items-center  lg:h-full lg:flex-row lg:gap-0 ">
                ...
                <div className="z-20 mx-auto mb-16 flex h-2/3 w-11/12 flex-col items-center justify-center gap-4  md:h-1/2 md:gap-8 lg:h-full lg:w-2/3 ">
                  <div>
                  ...
                  <p className="z-10 text-justify text-sm text-gray-800 dark:text-white md:text-xl lg:px-16 3xl:text-3xl">
                    I&lsquo;m Gonzalo Zucca, a Marketing graduate with a degree
                    ...
                    <br />
                    <br />
                    And I&lsquo;m excited to say that this is only the beginning
                    of my career in this ever-growing profession which is web
                    programming.
                  </p>
                </div>
              </div>
            ...
            <div className="mx-auto my-4 flex flex-col items-center justify-center sm:w-full md:w-10/12 lg:w-8/12">
              ...
              <div className=" py-8">
                <p className="px-6 text-justify text-base text-gray-800 dark:text-white md:text-2xl 3xl:text-3xl">
                  I&apos;m currently looking for full-time Frontend or
                  Full-Stack opportunities! If you know of any positions
                  available, if you have any questions, or if you just want to
