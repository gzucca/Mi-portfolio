      ...
      <Carousel slide={false} indicators={false}  leftControl="<" rightControl=">" className='text-3xl font-bold dark:text-white text-black' >
        <div className="font-normal md:w-[64rem] h-5/6 max-md:w-screen snap-center ">
          <div className="bg-white dark:bg-gray-400 h-full rounded shadow-lg p-6">
            ...
            <a href="https://pi-api-food.up.railway.app/" className="inline-block text-xl bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
              View project
            </a>
          </div>
        </div>
        <div className="md:w-[64rem] md:h-5/6 max-md:h-5/6 max-md:w-screen snap-center">
          <div className="font-normal bg-white dark:bg-gray-400 h-full rounded shadow-lg p-6">
            ...
            <a href="https://scaneame.vercel.app/" className="inline-block text-xl bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
              View project
            </a>
          </div>
        </div>
